...
<html>
    ...
    <body>
      ...
      <div class="boton-proyecto">
        <a href="index.php#servicios" class="boton-nuevoproyecto">Comenza tu nuevo proyecto</a>
      </div>
        ...
        <div class="contactanos">
          <div class="contacto-proyecto">
            ...
            <div class="boton-project">
              <a href="http://wa.me/3412294863" class="btn-proyecto">Escribimos</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- DIVIDER -->
          ...
          <ul>
            <li><a href="index.php#servicios">Basic</a></li>
            <li><a href="index.php#servicios">Estandar</a></li>
            <li><a href="index.php#servicios">Platinium</a></li>
            <li><a href="index.php#servicios">Gold</a></li>
            <li><a href="index.php#servicios">Premium</a></li>
            <li><a href="index.php#servicios">Mantenimiento</a></li>
          </ul>
        </div>
      ...
      <!-- DIVIDER -->
            <div class="divider-5"></div>
              <ul>
                <li>Rosario</li>
                <li><a href="http://wa.me/3412294863">3412294863</a></li>
